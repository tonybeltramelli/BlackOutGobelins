...
-(void) updateVertices {
	...
	float right=left+spriteSizeInPixels.width*(1/CC_CONTENT_SCALE_FACTOR());
	float bottom=0; //-spriteSizeInPixels.height*0.5f;
	float top=bottom+spriteSizeInPixels.height*(1/CC_CONTENT_SCALE_FACTOR());
	
    CGSize scaledCap = CGSizeMake(capSizeInPixels.width*(1/CC_CONTENT_SCALE_FACTOR()), capSizeInPixels.height*(1/CC_CONTENT_SCALE_FACTOR()));
	// From left to right
	
    vertexData[0].vertices=(ccVertex2F){left,top};
	vertexData[1].vertices=(ccVertex2F){left,top-scaledCap.height};
	vertexData[2].vertices=(ccVertex2F){left+scaledCap.width,top};
	vertexData[3].vertices=(ccVertex2F){left+scaledCap.width,top-scaledCap.height};
	// Center
	vertexData[4].vertices=(ccVertex2F){right-scaledCap.width,top};
	vertexData[5].vertices=(ccVertex2F){right-scaledCap.width,top-scaledCap.height};
	// Right
	vertexData[6].vertices=(ccVertex2F){right,top};
	vertexData[7].vertices=(ccVertex2F){right,top-scaledCap.height};
	
	//Center band
	// Left
	vertexData[8].vertices=(ccVertex2F){left,bottom+scaledCap.height};
	vertexData[9].vertices=(ccVertex2F){left,top-scaledCap.height};
	vertexData[10].vertices=(ccVertex2F){left+scaledCap.width,bottom+scaledCap.height};
	vertexData[11].vertices=(ccVertex2F){left+scaledCap.width,top-scaledCap.height};
	// Center
	vertexData[12].vertices=(ccVertex2F){right-scaledCap.width,bottom+scaledCap.height};
	vertexData[13].vertices=(ccVertex2F){right-scaledCap.width,top-scaledCap.height};
	// Right
	vertexData[14].vertices=(ccVertex2F){right,bottom+scaledCap.height};
	vertexData[15].vertices=(ccVertex2F){right,top-scaledCap.height};
	
	//Bottom band
	//Left
	vertexData[16].vertices=(ccVertex2F){left,bottom};
	vertexData[17].vertices=(ccVertex2F){left,bottom+scaledCap.height};
	vertexData[18].vertices=(ccVertex2F){left+scaledCap.width,bottom};
	vertexData[19].vertices=(ccVertex2F){left+scaledCap.width,bottom+scaledCap.height};
	// Center
	vertexData[20].vertices=(ccVertex2F){right-scaledCap.width,bottom};
	vertexData[21].vertices=(ccVertex2F){right-scaledCap.width,bottom+scaledCap.height};
	// Right
	vertexData[22].vertices=(ccVertex2F){right,bottom};
	vertexData[23].vertices=(ccVertex2F){right,bottom+scaledCap.height};
}
